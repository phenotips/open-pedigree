import { filterUnique } from 'pedigree/model/helpers';
...
VerticalPosIntOptimizer.prototype = {
  ...
  recursiveExhaustiveSearch: function ( componentID, valuesSoFar, level, bestSoFar ) {
    ...
    for (var i = minValue; i <= maxValue; i++ ) {
      ...
      if (bestSoFar.score == this.components.getMinPossiblePenalty(componentID)) {
        break;
      }
    }
...
export default VerticalPosIntOptimizer;
