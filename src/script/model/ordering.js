import { clone2DArray } from 'pedigree/model/helpers';

var Ordering = function (order, vOrder) {
...
Ordering.prototype = {
  ...
  deserialize: function(data) {
    this.order  = data;
    this.vOrder = [];
    //console.log("Order deserialization: [" + JSON.stringify(this.order) + "]");
  ...
  canMove: function(rank, index, amount) {
    ...
    if (newIndex > this.order[rank].length - 1) {
      return false;
    }
    return true;
  },
